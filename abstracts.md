...
<div class="content-container">
    ...
    <h4>  Presenters: Daniel Coleman, Rick Hill </h4>
        <p>
    ...
    <h4>  Presenters: Victoria Clowater </h4>
        <p>
    ...
    <br><br>
    <h2 id="Observe, report, extend: Designing projects to increase urban geography students' first-hand exposure to Hamilton" >Observe, report, extend: Designing projects to increase urban geography students' first-hand exposure to Hamilton</h2>
    <h4>  Presenter: Melanie Bedore </h4>
        <p>
    ...
    <h4>  Presenters: Robert Motum, Jojo Chooi-Harley, Jonathan Harley  </h4>
        <p>
    ...
    <p>
    As far as format goes, I am happy to do whatever works best for the program. I could do a more traditional 15-20 minute poetry reading, an artist talk about the writing and research in the book and my thinking around place/the city, or a media-based presentation focused on my research in the map library and how those materials helped shape my book.
    </p> -->
    <br><br>
    ...
    <h4>  Presenters: Zahra Tootonsab </h4>
        <p>
    ...
    <h4>  Presenters: Natasha Martinez, Meredith Leonard </h4>
        <p>
    ...
    <h4>  Presenters: Simon Orpana, Matt McInnes, Nancy Bouchier </h4>
        <p>
    ...
    <h4>  Presenter: Zahra Tootonsab  </h4>
    <br><br>
    ...
    <h4>  Presenter: Jordyn Beaupré </h4>
        <p>
    ...
    <h4>  Presenters: Abdulellah Hbbani (Abdo) </h4>
        <p>
        ...
        <p>
        Structured as a 20-minute presentation followed by Q&A, I will:
        • Share a story about Winston Churchill in Sudan (one of the British colonies) and how naming a park after him in Hamilton reproduces colonial exclusion.
        • Propose place-conscious ritual as an anecdote to colonial exclusion, anchored in the Two Row Wampum’s framework of mutual respect (Hill & Coleman, 2019).
        • Share examples from Pamoja, a biweekly tea gathering co-hosted with Hamilton’s Community Permaculture Lab, as a site where relationality and remembering disrupts settler-colonial amnesia.
        ...
        <p>
        Note: This presentation emerges from my independent research on newcomer treaty-informed citizenship and my lived experience as a Sudanese immigrant in Hamilton. It bridges theory (e.g., Coleman’s White Civility) and practice (e.g., Pamoja as placemaking practice).
        References:   
        </p>
        <p> 
        Coleman, Daniel. White Civility: The Literary Project of English Canada. University of Toronto Press, 2006.
        Hill, R. W., & Coleman, D. (2018). The Two Row Wampum-Covenant Chain Tradition as a Guide for Indigenous-University Research Partnerships. Cultural Studies ↔ Critical Methodologies, 19(5), 339-359. (Original work published 2019)
        </p>
    <br><br>
    ...
    <h4>  Presenter: Stephanie Sushko </h4>
        <p>
        ...
        <p>
        My presentation would involve discussing the purpose, context, and rationale behind the poetry map, briefly exploring the map itself with viewers in order to illustrate the unique perspective which it brings to the city space, and sharing a poem which I have written and contributed to the map and which touches upon the themes which undergird the project. The presentation would likely take approximately 15 minutes’ time, although can be easily shortened if needed.
        </p>
    <br><br>
    ...
    <h4>  Presenters: Joonsoo Sean Lyeo, Allison Williams, Bharati Sethi </h4>
        <p>
    ...
    <h4>  Presenter: Esther Kok</h4>
        ...
        <p>
	    I would anticipate my work being presented in the form of a short talk with some interactive components, including a group activity, and a condensed reading of select zines (with the option to read them all in an exhibit-style display). 
        </p>
        <br><br>
    ...
    <h4>  Presenters: Gary Barwin, Sarah Imrisek</h4>
        <p>
